...
const popup = "";
const App = () => {
  const [status, setStatus] = reactExports.useState("Click to scan page for faces");
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      await new Promise((resolve) => {
        setTimeout(() => {
          chrome.tabs.sendMessage(tab.id, { action: "ANALYZE_VIDEO" }).finally(() => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 w-[320px] h-[400px] flex items-center justify-center bg-background text-foreground font-sans", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "w-full h-full border-border bg-card/50 backdrop-blur-sm flex flex-col justify-between shadow-2xl rounded-[2rem]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { className: "pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-2 bg-primary/10 rounded-2xl", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ShieldCheck, { className: "h-6 w-6 text-primary" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-blue-500", children: "TruthLens" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { className: "text-muted-foreground text-xs font-medium", children: "Anti-Deepfake Verification" })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "space-y-4 flex-1 flex flex-col justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `
                        flex items-center justify-center p-4 rounded-2xl border
                        min-h-[100px] transition-colors duration-300
                        ${status.includes("Error") ? "bg-red-500/10 border-red-500/20 text-red-200" : "bg-secondary/50 border-border text-muted-foreground"}
                    `, children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-center font-medium leading-relaxed", children: status }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(CardFooter, { className: "pt-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      Button,
      {
        ...
        children: isAnalyzing ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Activity, { className: "mr-2 h-5 w-5 animate-spin" }),
          "Analyzing..."
        ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Video, { className: "mr-2 h-5 w-5" }),
          "Analyze Video"
        ] })
      }
    ) })
